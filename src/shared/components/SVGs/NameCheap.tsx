...
const SvgNameCheap = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      ...
      >
        ...
        <stop offset="4.166%" stopColor="#D82D2B" stopOpacity={0.958} />
        <stop offset="17.6%" stopColor="#E25226" stopOpacity={0.824} />
        <stop offset="31.67%" stopColor="#EB7123" stopOpacity={0.683} />
        <stop offset="46.35%" stopColor="#F28920" stopOpacity={0.536} />
        <stop offset="61.88%" stopColor="#F69A1E" stopOpacity={0.381} />
        <stop offset="78.86%" stopColor="#F9A41D" stopOpacity={0.211} />
